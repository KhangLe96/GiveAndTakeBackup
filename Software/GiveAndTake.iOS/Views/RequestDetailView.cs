    ...
    public class RequestDetailView : BaseView
    {
        ...
        private void InitContentView()
        {
            ...
            _contentView.AddConstraints(new[]
            {
                ...
                NSLayoutConstraint.Create(_scrollView, NSLayoutAttribute.Bottom, NSLayoutRelation.Equal, _btnReject,
                    NSLayoutAttribute.Top, 1, -DimensionHelper.DefaultMargin)

            });
            _lbRequestMessage = UIHelper.CreateLabel(UIColor.Black, DimensionHelper.PostDescriptionTextSize);
            _scrollView.Add(_lbRequestMessage);
            _scrollView.AddConstraints(new[]
            {
                NSLayoutConstraint.Create(_lbRequestMessage, NSLayoutAttribute.Top, NSLayoutRelation.Equal, _scrollView,
                    NSLayoutAttribute.Top, 1, 0),
                NSLayoutConstraint.Create(_lbRequestMessage, NSLayoutAttribute.Left, NSLayoutRelation.Equal, _scrollView,
                    NSLayoutAttribute.Left, 1, DimensionHelper.DefaultMargin),
                NSLayoutConstraint.Create(_lbRequestMessage, NSLayoutAttribute.Right, NSLayoutRelation.Equal, _scrollView,
                    NSLayoutAttribute.Right, 1, -DimensionHelper.DefaultMargin),
                NSLayoutConstraint.Create(_lbRequestMessage, NSLayoutAttribute.Bottom, NSLayoutRelation.Equal, _scrollView,
                    NSLayoutAttribute.Bottom, 1, 0)
            });
        }
    }
